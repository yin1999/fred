...
export class QuickSearch extends LitElement {
  static styles = css`
    .quick-search {
      ...
      &:focus-within {
        width: 192px;
        outline: 2px solid var(--quick-search-blue);
        outline-offset: 2px;
      }
    }
  ...
  render() {
    ...
    return html`<form class="quick-search" action="/en-US/search">
      ...
      <button
        ...
        type="reset"
      >
        <svg width="16" height="16" viewBox="-64 0 512 512" aria-label="Clear">
      ...
      <button class="quick-search__button" type="submit">
        <svg width="16" height="16" viewBox="0 0 512 512" aria-label="Send">
          <!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
          <path
